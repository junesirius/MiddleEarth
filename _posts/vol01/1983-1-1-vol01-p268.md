...
page_num: 268
characters: 
tags: ['Bëor', 'Dark Elves', 'Dwarves', 'Eldar', 'Elmir', 'Ermon', 'Fangli', 'Fay(s)', 'Fúkil', 'Haven of the Sun', 'Ilkorin(s)', 'Ilkorin tongue', 'Melko', 'Men', 'Murmenalda', 'Nauglath', 'Nuin', 'Orcs', 'Father of Speech', 'Palisor', 'Quendi', 'Silmarillion, The']
description: 
published: true
---
